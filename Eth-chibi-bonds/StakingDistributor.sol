...
contract StakingDistributor is Ownable {
    ...
    constructor( address _treasury, address _chibi, uint32 _epochLength, uint32 _nextEpochTime ) {        
    ...
    function nextRewardAt( uint _rate ) public view returns ( uint ) {
        return chibi.totalSupply().mul( _rate ).div( 1000000 );
    }
