...
contract sKeplerERC20 is ERC20 {
    ...
    constructor() ERC20("Staked chibi", "TROVE") {
    ...
    /**
        @notice increases schibi supply to increase staking balances relative to _profit
    ...
    */
    ...
    // Staking contract holds excess schibi
